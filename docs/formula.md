## Mathematical Formulas for PID Tuning Algorithms

This document contains the complete mathematical formulas used by each PID tuning algorithm in the AutoTunePID library.

## Table of Contents

- [1. Ziegler-Nichols](#1-ziegler-nichols)
- [2. Cohen-Coon](#2-cohen-coon)
- [3. IMC (Internal Model Control)](#3-imc-internal-model-control)
- [4. Tyreus-Luyben](#4-tyreus-luyben)
- [5. Lambda Tuning (CLD)](#5-lambda-tuning-cld)
- [Ultimate Gain and Oscillation Period](#ultimate-gain-and-oscillation-period)
- [Process Parameter Estimation](#process-parameter-estimation)
- [Time-Based PID Calculations](#time-based-pid-calculations)
...
2. **Process Parameter Estimation**: 
    $ T \approx 0.67 \cdot T_u $, $ L \approx 0.17 \cdot T_u $ 

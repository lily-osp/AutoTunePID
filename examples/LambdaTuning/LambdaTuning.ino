...
AutoTunePID pid(0.0f, 255.0f, TuningMethod::LambdaTuning); // Create PID controller with minOutput=0, maxOutput=255, and Relay-Feedback tuning method
...
void setup()
{
    ...
    pid.setLambda(0.7f); // Set lambda parameter for Lambda Tuning
